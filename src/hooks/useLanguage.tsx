...
const translations = {
  es: {
    ...
    // Blog Article 2: Additional translations
    'blog.backToNews': 'Volver a Noticias',
    'blog.article2.intro.p4': 'Pero, ¿en qué consiste exactamente un suelo epoxi? A continuación os damos las claves de un pavimento continuo con enormes posibilidades y excelentes prestaciones técnicas.',
    'blog.article2.imgCaption1': 'Planta baja de una nave industrial en la que se ha aplicado suelo de resina epoxi.',
    'blog.article2.imgCaption2': 'Un par de operarios aplicando suelo de resina epoxi en un almacén.',
    'blog.article2.imgCaption3': 'Amplio pasillo de oficina cuyo suelo se ha recubierto con pintura epoxi.',
    'blog.article2.imgCaption4': 'Pequeña cocina abierta al salón en forma de L con suelo de resina epoxi.',
    'blog.article2.imgCaption5': 'Concesionario de coches con suelo de resina epoxi en todo el pavimento.',
    'blog.article2.imgCaption6': 'Amplia fábrica en la que se ha aplicado suelo de resina epoxi.',
    'blog.article2.imgCaption7': 'Operario aplicando suelo de resina epoxi en la planta principal de una fábrica.',
    'blog.article2.char.intro': 'El suelo epoxi presenta importantes beneficios, pero también algún que otro inconveniente. Factores que hay que evaluar para determinar si es el tipo de pavimento que se está buscando y si se adapta o no a los gustos y necesidades. A continuación desarrollamos los principales:',
    ...
    'blog.article2.price.summary': 'En definitiva, el precio por m2 de un suelo de resina epoxi está sujeto a los siguientes factores:',
    'blog.article2.wood.intro': 'Seguro que te has fijado en esos originales muebles y suelos de madera encapsulados en resina epoxi. Si te gusta este rompedor acabado decorativo y te preguntas cómo hacerlo, estás en el lugar correcto.',
    'blog.article2.wood.intro2': 'Desarrollamos las principales cualidades que hacen de la resina epoxi el gran aliado de los suelos de madera. ¡Atención!',
    'blog.article2.home.intro': 'Ha quedado sobradamente claro que por las particularidades de los suelos epoxi, son pavimentos que se mueven en el ámbito industrial y comercial. Ahora, ha llegado el momento de exponer los motivos por los que últimamente se ha disparado su uso en los hogares. Cinco son las razones principales del boom del suelo de resina epoxi en la vivienda.',
    'blog.article2.home.section1': '1. Suelo de resina epoxi en la vivienda: estética novedosa',
    'blog.article2.home.section2': '2. La gran compatibilidad del suelo epoxi',
    'blog.article2.home.section3': '3. Impermeabilidad 100%',
    'blog.article2.home.section4': '4. El suelo epoxi es antideslizante',
    'blog.article2.home.section5': '5. Limpieza y mantenimiento mínimo',
    'blog.article2.exterior.p1': 'El amarilleamiento es uno de los principales inconvenientes de utilizar un suelo de resina epoxi en el exterior, ya que es un pavimento sensible a los rayos solares y a las inclemencias atmosféricas. De ahí, que su uso predominante sea como revestimiento continuo interior y no sea muy popular para exterior.',
    'blog.article2.exterior.p2': 'No obstante, esto no significa que no pueda hacerse de ninguna de las maneras. Con un correcto tratamiento se puede solventar el handicap del amarilleamiento y apostar por un suelo de resina epoxi en el exterior. Si estás convencido en servirte de este pavimento para terrazas, presta atención.',
    'blog.article2.exterior.sealTitle': 'Cómo sellar el suelo de resina epoxi para poder aplicarlo en exterior',
    'blog.article2.cta.title': '¿Necesitas asesoramiento profesional?',
  ...
  en: {
    ...
    'blog.article2.intro.p4': 'But what exactly does an epoxy floor consist of? Below we provide the keys to a continuous flooring with enormous possibilities and excellent technical performance.',
    'blog.article2.imgCaption1': 'Ground floor of an industrial warehouse where epoxy resin flooring has been applied.',
    'blog.article2.imgCaption2': 'A couple of workers applying epoxy resin flooring in a warehouse.',
    'blog.article2.imgCaption3': 'Wide office hallway whose floor has been coated with epoxy paint.',
    'blog.article2.imgCaption4': 'Small L-shaped kitchen open to the living room with epoxy resin flooring.',
    'blog.article2.imgCaption5': 'Car dealership with epoxy resin flooring throughout the pavement.',
    'blog.article2.imgCaption6': 'Large factory where epoxy resin flooring has been applied.',
    'blog.article2.imgCaption7': 'Worker applying epoxy resin flooring on the main floor of a factory.',
    'blog.article2.char.intro': 'Epoxy flooring has important benefits, but also some disadvantages. Factors that must be evaluated to determine if it is the type of flooring you are looking for and whether it adapts to your tastes and needs. Below we develop the main ones:',
    'blog.article2.uses.intro': 'An epoxy resin floor can be installed on almost any surface. Its low thickness allows very quick maintenance. However, there are some places where its use is more frequent than others. Next, we will develop the main areas where we find this continuous flooring.',
    'blog.article2.price.summary': 'In short, the price per m2 of an epoxy resin floor is subject to the following factors:',
    'blog.article2.wood.intro': 'You have surely noticed those original furniture and wooden floors encapsulated in epoxy resin. If you like this groundbreaking decorative finish and wonder how to do it, you are in the right place.',
    'blog.article2.wood.intro2': 'We develop the main qualities that make epoxy resin the great ally of wooden floors. Attention!',
    'blog.article2.home.intro': 'It has been more than clear that due to the particularities of epoxy floors, they are floorings that operate in the industrial and commercial field. Now, the time has come to expose the reasons why their use in homes has recently skyrocketed. Five are the main reasons for the boom of epoxy resin flooring in housing.',
    'blog.article2.home.section1': '1. Epoxy resin flooring in housing: novel aesthetics',
    'blog.article2.home.section2': '2. The great compatibility of epoxy flooring',
    'blog.article2.home.section3': '3. 100% waterproofing',
    'blog.article2.home.section4': '4. Epoxy flooring is non-slip',
    'blog.article2.home.section5': '5. Minimal cleaning and maintenance',
    'blog.article2.exterior.p1': 'Yellowing is one of the main disadvantages of using epoxy resin flooring outdoors, as it is a pavement sensitive to sunlight and weather conditions. Hence, its predominant use is as an interior continuous coating and it is not very popular for exteriors.',
    'blog.article2.exterior.p2': 'However, this does not mean that it cannot be done in any way. With proper treatment, the yellowing handicap can be solved and an epoxy resin floor can be used outdoors. If you are convinced to use this flooring for terraces, pay attention.',
    'blog.article2.exterior.sealTitle': 'How to seal epoxy resin flooring to apply it outdoors',
    'blog.article2.cta.title': 'Need professional advice?',
